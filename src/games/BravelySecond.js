...
const PU_BS = ({setJobSetOfFour, setRules}) => {
...
const U_BS = ({setJobSetOfFour, setRules}) => {
...
const ANY_BS = ({setJobSetOfFour, setRules}) => {
  return (
    <button onClick={() => {
      let jobIndices = [];
      while (jobIndices.length < 4) {
...
const BS_ONLY_U_BS = ({setJobSetOfFour, setRules}) => {
  return (
    <button onClick={() => {
      let jobIndices = [];
...
const BravelySecondBody = () => {
  ...
  return (
    <>
      ...
      <PU_BS setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
      <U_BS setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
      <ANY_BS setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
      <BS_ONLY_U_BS setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
