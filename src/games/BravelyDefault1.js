...
const PU_BD1 = ({setTypeOfRun, setJobSetOfFour, setRules}) => {
...
const U_BD1 = ({setTypeOfRun, setJobSetOfFour, setRules}) => {
...
const ANY_BD1 = ({setTypeOfRun, setJobSetOfFour, setRules}) => {
  return (
    <button onClick={() => {
      let jobIndices = [];
      while (jobIndices.length < 4) {
...
const BravelyDefault1Body = () => {
  ...
  return (
    <>
      ...
      <PU_BD1 setTypeOfRun={setTypeOfRun} setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
      <U_BD1 setTypeOfRun={setTypeOfRun} setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
      <ANY_BD1 setTypeOfRun={setTypeOfRun} setJobSetOfFour={setJobSetOfFour} setRules={setRules} />
